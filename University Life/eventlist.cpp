...
void EventList::createMissingDogEvent() {
  Event *ToplevelDogScene =
      new Event("You see a small dog lying in the road",
                ...
                "Run over and see if it's ok", "", false, false, 0, 1);

  // top level's left option
  Event *MidlevelDogSceneA = new Event(
      "You ignore the dog, like a heartless monster. You hear him "
      "whine softly.",
      " Keep walking.", " He needs help go help him !", "", false, false, 2, 3);
  ...
  Event *BottomlevelDogSceneB = new Event(
      ...
      "Take him to raps?", "Give him your lunch?", "", true, false, -1, -1);
